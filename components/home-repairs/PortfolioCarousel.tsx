...
export function PortfolioCarousel() {
  const portfolioItems = getHomeRepairsPortfolio();
  ...
  return (
    <div className="portfolio-carousel-wrapper w-full max-w-full">
      <Swiper
        ...
        pagination={{ 
          clickable: true,
          bulletClass: 'swiper-pagination-bullet portfolio-bullet-home-repairs',
          bulletActiveClass: 'swiper-pagination-bullet-active portfolio-bullet-active-home-repairs',
          el: '.portfolio-pagination-home-repairs'
        }}
        navigation={{
          prevEl: '.portfolio-button-prev-home',
          nextEl: '.portfolio-button-next-home'
        }}
        loop={true}
      ...
      {/* Navigation Buttons */}
      <button 
        className="portfolio-button-prev-home"
      ...
      <button 
        className="portfolio-button-next-home"
      ...
      <style>{`
        ...
        .portfolio-button-prev-home,
        .portfolio-button-next-home {
          position: absolute;
          top: 45%;
        ...
        .portfolio-button-prev-home:hover,
        .portfolio-button-next-home:hover {
          background: #C6A778;
          color: white;
        ...
        .portfolio-button-prev-home:disabled,
        .portfolio-button-next-home:disabled {
          opacity: 0.3;
          cursor: not-allowed;
        }
        ...
        .portfolio-bullet-home-repairs:hover {
          opacity: 1;
        }
        
        .portfolio-bullet-active-home-repairs {
