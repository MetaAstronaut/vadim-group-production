...
import { getGeneralTestimonials } from '@/data/testimonials';
...
export default function TestimonialsCarousel() {
  const reviewsData = getGeneralTestimonials();
